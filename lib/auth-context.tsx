...
//   useEffect(() => {
//     const auth = localStorage.getItem("crypto_auth")
//     if (auth === "true") {
...
//       localStorage.setItem("crypto_auth", "true")
//       localStorage.setItem("crypto_user_email", email)
//       setIsAuthenticated(true)
//       return true
//     }
//     return false
...
//     localStorage.removeItem("crypto_user_email")
//     setIsAuthenticated(false)
//   }

//   return (
//     <AuthContext.Provider value={{ isAuthenticated, isLoading, login, signup, resetPassword, logout }}>
//       {children}
